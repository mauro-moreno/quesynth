...
//
// Deliberately the same shape as tools/render/main.odin and tools/s1probe/wav.odin
// so the self-test's output is byte-comparable with the offline renderer's,
// header and all. A standalone build that disagreed with the renderer about the
// container would make every null test against it meaningless.
